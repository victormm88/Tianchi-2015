...
def main():
    csv_reader =\
    csv.reader(open('possible_feature_2014-12-19_add_user_category_add_user.csv','rb'));
    tittle=csv_reader.next();
    csv_writer=csv.writer(open('possible_feature_2014-12-19_add_user_category_add_user_proportion.csv','wb'));
