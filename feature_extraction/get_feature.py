...
class Get_feature:
    ...
    def get_beh_feature(self,result,died_day,day_num):
        ...
        beh_list=['look','collection','add','buy'];
        for beh in beh_list:
        ...
        for row in result:
            ...
            #delete later
            if time=='2014-12-17' or time=='2014-12-18':
                continue;
        ...
        result_dir['last_act']=last_act;
        result_dir['last_buy']=last_buy;
        return result_dir;
...
if __name__=='__main__':
    gf=Get_feature();
    sql="""select * from train_data where user_id="%s" and item_id="%s" """ % (96089426,114407102);
    gf.cursor.execute(sql);
    print gf.cursor.fetchall();
    print gf.get_pair_feature(96089426,114407102,17,29);
